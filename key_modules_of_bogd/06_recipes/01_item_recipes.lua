...
AddRecipeToFilter("bogd_treasure_lv_up_meteorites","CHARACTER")     ---- 添加物品到目标标签
AddRecipe2(
    "bogd_treasure_lv_up_meteorites",            --  --  inst.prefab  实体名字
    ...
    TECH.CELESTIAL_ONE, --- TECH.NONE
    {
        nounlock = true,
        -- no_deconstruction = false,
        atlas = "images/inventoryimages/bogd_treasure_lv_up_meteorites.xml",
        image = "bogd_treasure_lv_up_meteorites.tex",
    },
    {"CHARACTER","MAGIC"}
)
-- RemoveRecipeFromFilter("bogd_item_body_integration_pill","MODS")                       -- -- 在【模组物品】标签里移除这个。
