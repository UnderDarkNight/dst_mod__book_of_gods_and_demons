...
AddStategraphState("wilson",State{
    ...
    onenter = function(inst)
        ...
        inst.SoundEmitter:PlaySound("dontstarve/wilson/eat", "bogd_special_quick_eat")
    ...
    timeline =
        {
			...
			TimeEvent(60 * FRAMES, function(inst)
                inst.SoundEmitter:KillSound("bogd_special_quick_eat")
                inst:PerformBufferedAction()
...
AddStategraphState("wilson_client",State{
    name = "bogd_special_quick_eat",
    tags = { "doing", "busy", "canrotate","nointerrupt" },
    server_states = { "bogd_special_quick_eat" },
