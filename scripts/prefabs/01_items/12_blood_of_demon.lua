...
----------------------------------------------------------------------------------------------------------------------------------------------------
---
    local prefab_name = "bogd_item_blood_of_demon"

    local assets = {
        Asset("ANIM", "anim/bogd_item_blood_of_demon.zip"), 
        Asset( "IMAGE", "images/inventoryimages/bogd_item_blood_of_demon.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/bogd_item_blood_of_demon.xml" ),
    }
------------------------------------------------------------------------------------------------------
--- workable setup
...
local function fn()
    ...
    -- inst.AnimState:SetBank("bogd_item_blood_of_demon") -- 地上动画
    -- inst.AnimState:SetBuild("bogd_item_blood_of_demon") -- 材质包，就是anim里的zip包
