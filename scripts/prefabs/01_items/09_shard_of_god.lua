...
----------------------------------------------------------------------------------------------------------------------------------------------------
---
    local prefab_name = "bogd_item_shard_of_god"

    local assets = {
        Asset("ANIM", "anim/bogd_item_shard_of_god.zip"), 
        Asset( "IMAGE", "images/inventoryimages/bogd_item_shard_of_god.tex" ),  -- 背包贴图
...
local function fn()
    ...
    -- inst.AnimState:SetBank("bogd_item_shard_of_god") -- 地上动画
    -- inst.AnimState:SetBuild("bogd_item_shard_of_god") -- 材质包，就是anim里的zip包
