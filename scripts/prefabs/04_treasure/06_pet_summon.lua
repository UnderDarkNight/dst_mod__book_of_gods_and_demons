...
local assets =
{
    Asset("ANIM", "anim/bogd_treasure_pet_summon.zip"),

    Asset( "IMAGE", "images/inventoryimages/bogd_treasure_pet_summon.tex" ),  -- 物品贴图
    Asset( "ATLAS", "images/inventoryimages/bogd_treasure_pet_summon.xml" ),  -- 物品贴图

    Asset( "IMAGE", "images/treasure/bogd_treasure_pet_summon.tex" ),         -- UI贴图
    Asset( "ATLAS", "images/treasure/bogd_treasure_pet_summon.xml" ),         -- UI贴图
...
--- 主函数
    local function fn()
        ...
        inst.AnimState:SetBank("bogd_treasure_pet_summon")
        inst.AnimState:SetBuild("bogd_treasure_pet_summon")
        ...
        --- 标准物品库
            ...
            inst.components.inventoryitem.imagename = "bogd_treasure_pet_summon"
            inst.components.inventoryitem.atlasname = "images/inventoryimages/bogd_treasure_pet_summon.xml"
        ----------------------------------------------------------------------------------------------
        --- 
        ----------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
return Prefab("bogd_treasure_pet_summon", fn, assets)
