...
local assets =
{
    Asset("ANIM", "anim/bogd_treasure_frostfall.zip"),

    Asset( "IMAGE", "images/inventoryimages/bogd_treasure_frostfall.tex" ),  -- 物品贴图
    Asset( "ATLAS", "images/inventoryimages/bogd_treasure_frostfall.xml" ),  -- 物品贴图

    Asset( "IMAGE", "images/treasure/bogd_treasure_frostfall.tex" ),         -- UI贴图
    Asset( "ATLAS", "images/treasure/bogd_treasure_frostfall.xml" ),         -- UI贴图
...
--- 主函数
    local function fn()
        ...
        inst.AnimState:SetBank("bogd_treasure_frostfall")
        inst.AnimState:SetBuild("bogd_treasure_frostfall")
        ...
        --- 标准物品库
            ...
            inst.components.inventoryitem.imagename = "bogd_treasure_frostfall"
            inst.components.inventoryitem.atlasname = "images/inventoryimages/bogd_treasure_frostfall.xml"
        ----------------------------------------------------------------------------------------------
        --- 
        ----------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
return Prefab("bogd_treasure_frostfall", fn, assets)
