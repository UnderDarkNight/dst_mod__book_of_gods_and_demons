...
local assets =
{
    Asset("ANIM", "anim/bogd_treasure_lv_up_excample.zip"),

    Asset( "IMAGE", "images/inventoryimages/bogd_treasure_lv_up_excample.tex" ),  -- 物品贴图
    Asset( "ATLAS", "images/inventoryimages/bogd_treasure_lv_up_excample.xml" ),  -- 物品贴图

}
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- workable 组件。方便替换掉已有的 灵宝
    local target_prefab = nil
...
--- 主函数
    local function fn()
        ...
        inst.AnimState:SetBank("bogd_treasure_lv_up_excample")
        inst.AnimState:SetBuild("bogd_treasure_lv_up_excample")
        ...
        --- 标准物品库
            ...
            inst.components.inventoryitem.imagename = "bogd_treasure_lv_up_excample"
            inst.components.inventoryitem.atlasname = "images/inventoryimages/bogd_treasure_lv_up_excample.xml"
        ----------------------------------------------------------------------------------------------
        --- 
        ----------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
return Prefab("bogd_treasure_lv_up_excample", fn, assets)
