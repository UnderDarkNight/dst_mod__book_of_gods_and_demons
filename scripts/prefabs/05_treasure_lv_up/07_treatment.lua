...
local assets =
{
    Asset("ANIM", "anim/bogd_treasure_lv_up_treatment.zip"),

    Asset( "IMAGE", "images/inventoryimages/bogd_treasure_lv_up_treatment.tex" ),  -- 物品贴图
    Asset( "ATLAS", "images/inventoryimages/bogd_treasure_lv_up_treatment.xml" ),  -- 物品贴图

}
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- workable 组件。方便替换掉已有的 灵宝
    local target_prefab = "bogd_treasure_treatment"
...
--- 主函数
    local function fn()
        ...
        inst.AnimState:SetBank("bogd_treasure_lv_up_treatment")
        inst.AnimState:SetBuild("bogd_treasure_lv_up_treatment")
        ...
        --- 标准物品库
            ...
            inst.components.inventoryitem.imagename = "bogd_treasure_lv_up_treatment"
            inst.components.inventoryitem.atlasname = "images/inventoryimages/bogd_treasure_lv_up_treatment.xml"
        ----------------------------------------------------------------------------------------------
        --- 
        ----------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
return Prefab("bogd_treasure_lv_up_treatment", fn, assets)
